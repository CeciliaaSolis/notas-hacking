...
--2025-05-03 02:23:13--  https://mercury.picoctf.net/static/c0da20f29337e87ffb58ea987d8c596e/Forensics%20is%20fun.pptm
...
Forensics is fun.pptm     100%[====================================>]  97.75K   566KB/s    in 0.2s    

2025-05-03 02:23:13 (566 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]

                                                                                                       
┌──(kali㉿kali)-[~]
└─$ ls
 capture.pcap     dolls.jpg              fixme2.tar.gz            mystery          shell.php
 capture.pcap.1   _dolls.jpg.extracted   fixme3                   picopico.key     Templates
 capture.pcap.2   Downloads              fixme3.tar.gz            picopico.key.1   tunn3l_v1s10n.bmp
 capture.pcap.3   fixme1                'Forensics is fun.pptm'   picopico.key.2   Videos
 Desktop          fixme1.tar.gz          message.wav              Pictures         vulture.jpg
 Documents        fixme2                 Music                    Public
...
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}flag:: command not found
...
*Descargamos el archivo, vemos de que tipo es,como esta comprimido lo descomprimimos y hacemos un echo para convertir la cadena sin espacios a base 64 y nos muestra la bandera.*

## Referencias 

https://mercury.picoctf.net/static/c0da20f29337e87ffb58ea987d8c596e/Forensics%20is%20fun.pptm
