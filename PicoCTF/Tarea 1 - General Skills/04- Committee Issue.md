...
```
ceciSolis-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c_titan/136/challenge.zip
--2025-02-23 04:30:56--  https://artifacts.picoctf.net/c_titan/136/challenge.zip
...
2025-02-23 04:30:56 (3.38 MB/s) - 'challenge.zip' saved [19196/19196]
...
ceciSolis-picoctf@webshell:~/drop-in$ ls -a
.  ..  .git  message.txt
ceciSolis-picoctf@webshell:~/drop-in$ cd drop-in/
-bash: cd: drop-in/: No such file or directory
ceciSolis-picoctf@webshell:~/drop-in$ cd drop-in/
-bash: cd: drop-in/: No such file or directory
ceciSolis-picoctf@webshell:~/drop-in$ cd ..
ceciSolis-picoctf@webshell:~$ cd drop-in/
ceciSolis-picoctf@webshell:~/drop-in$ ls -a git log
ls: cannot access 'git': No such file or directory
ls: cannot access 'log': No such file or directory
ceciSolis-picoctf@webshell:~/drop-in$ git log
ceciSolis-picoctf@webshell:~/drop-in$ 
ceciSolis-picoctf@webshell:~/drop-in$ git checkout 87b85d7dfb839b077678611280fa023d76e017b8
...
ceciSolis-picoctf@webshell:~/drop-in$ cat message.py
cat: message.py: No such file or directory
ceciSolis-picoctf@webshell:~$ cd drop-in/
...
https://hackmd.io/@mochimamrifai/BJwrJM48C
